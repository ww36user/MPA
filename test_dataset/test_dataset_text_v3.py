...
class SetDataset:
    ...
    def __getitem__(self, i):
        ...
        class_dataset = self.classes_datasets[single_label]
        list_ = []
    ...
    "This is a satellite image of SeaLake, capturing large bodies of water with clearly defined boundaries, often showing variations in water color, nearby coastlines, and surrounding terrain."
            ...
            class_dataset2 = classes_euroSAT_name[single_label]
            classes_des1 = euroSAT_des1[single_label]
            classes_des2 = euroSAT_des2[single_label]
            classes_des3 = euroSAT_des3[single_label]
            classes_des4 = euroSAT_des4[single_label]
            classes_des5 = euroSAT_des5[single_label]

            list_.append(data)
            list_.append(label)
            list_.append(class_dataset)
            list_.append(class_dataset2)
            list_.append(classes_des1)
            list_.append(classes_des2)
            list_.append(classes_des3)
            list_.append(classes_des4)
            list_.append(classes_des5)
